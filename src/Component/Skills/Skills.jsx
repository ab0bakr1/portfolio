  ...
  const allSkills = [
    ...
    { 
      ...
      icon: (
        ...
        >
          {/* الدائرة الخارجية */}
          <path d="M12 2L15.09 5.09L18.18 8.18L21.27 11.27V12.73L18.18 15.82L15.09 18.91L12 22L8.91 18.91L5.82 15.82L2.73 12.73V11.27L5.82 8.18L8.91 5.09L12 2Z" />
          {/* حرف C */}
          <path d="M14 9.5C13.5 9.1 12.8 8.9 12 8.9C10.3 8.9 9 10.3 9 12C9 13.7 10.3 15.1 12 15.1C12.8 15.1 13.5 14.9 14 14.5" />
          {/* علامة الهاشتاج # */}
          <path d="M15.5 11H19.5M15.5 13H19.5M16.5 10V14M18.5 10V14" />
        </svg>
  )
}
  ];
