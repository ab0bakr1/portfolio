...
const Skills = () => {
  ...
  const allSkills = [
    ...
    { 
      name: "C#", 
      type: "svg", 
      icon: <svg viewBox="0 0 48 48" width="50" height="50"><path fill="#EE5E16" d="M24,10c7.727,0,14,6.273,14,14s-6.273,14-14,14s-14-6.273-14-14S16.273,10,24,10z M24,17c3.863,0,7,3.136,7,7c0,3.863-3.137,7-7,7s-7-3.137-7-7C17,20.136,20.136,17,24,17z M34 20h1v8h-1z M37 20h1v8h-1z M32 25h8v1h-8z M32 22h8v1h-8z"/></svg> 
    }
  ];
