      ...
      <Container>
        ...
        <Row className="skills-grid">
          {skillData.map((skill, index) => (
                  ...
                  <div className="progress-wrapper">
                    <div className="progress-bar-custom">
                      <motion.div 
                        ...
                        initial={{ width: 0 }}
                        whileInView={{ width: "95%" }} // يمكنك تخصيص النسبة لكل مهارة
            ...
            <Col key={index} lg={4} md={6} xs={12} className="mb-4">
              <motion.div 
                className="skill-card text-only"
                initial={{ opacity: 0, scale: 0.9 }}
                whileInView={{ opacity: 1, scale: 1 }}
                whileHover={{ y: -10 }}
                transition={{ duration: 0.3, delay: index * 0.1 }}
        ...
        >
          <p>Other Tools: CSS • MongoDB • Express.js • Tailwind CSS • Bootstrap • API Integration • Git</p>
        </motion.div>
      </Container>
    </section>
  );
